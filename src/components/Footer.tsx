...
export default function Footer() {
  return (
    <footer className="footer">
      {/* Remove the wave if rolling back completely */}
      
      <div className="footer-images">
        {badgeLinks.map(({ src, alt, href }) => (
          <a key={alt} href={href} target="_blank" rel="noopener noreferrer" className="footer-badge-link">
            <img src={src} alt={alt} />
          </a>
        ))}
      </div>
      ...
      <div className="footer-contact">
        <div className="footer-contact-item">
          ...
          <a href="https://maps.google.com/?cid=2414852586862273599&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNl" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-contact-item">
          ...
          <a href="mailto:kettlemoraineprocleaners@gmail.com">kettlemoraineprocleaners@gmail.com</a>
        </div>
      </div>
      ...
      <p className="credit">
        Website by <a href="https://zhowellportfolio.netlify.app/" target="_blank" className="zach">Zachary Howell</a>
